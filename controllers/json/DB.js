    ...
    libros : [
      {
        ...
        archivo:'Cabrer_1797',
        estilo:'Zoomify. Pedir imagen en alta al Archivo de Bogotá',
      },
      {
        titulo:'Papel Periódico de Santafé de Bogotá (Nº264:30-XII-1796: 1605-1607). Santafé de Bogotá, Imprenta Real de Santafé, 1796.',
        autor:'',
      ...
      {
        titulo:'“Los frutos del árbol noble” en Papel Periódico de Santafé de Bogotá (Nº3: 25-II-1791:Pag. 13 y 14).',
...
//    {titulo:'',parrafos:['']},
  ...
  libros : [
    ...
    {
      titulo:'Copia de auto de la Rl. Aud. para recog. los libros prohibidos de don Ant. Nariño :|bdocumentos no. 5  / Fran. Xavier Esterripa',
      autor:'',
      hover:'',
      pie:'',
      url:'Pendiente URL de Conservación ',
    ...
    {
      titulo:'El proceso de Nariño',
      autor:'',
      hover:'',
      pie:'',
      url:'http://www.bdigital.unal.edu.co/8059/1/Archivo_Nari%C3%B1o.html#12c',
      archivo:'',
      estilo:'Hipervínculo a UNAL ',
    },
    {
      titulo:'El proceso de Nariño',
      autor:'',
      hover:'',
      pie:'',
      url:'http://www.bdigital.unal.edu.co/8059/1/Archivo_Nari%C3%B1o.html#58c',
      archivo:'',
      estilo:'Hipervínculo a UNAL ',
    },
    {
    ...
    {
      titulo:'Elementa chemiae: quae anniversario labore docuit, in publicis, privatisque scholis',
      autor:'Boerhaave, Hermann',
      hover:'Elementa chemiae (1752). Hermann Boerhaave',
      pie:'Paris: Apud Vuduam Cavelier, 1752-1753. BNC: RG 5187, RG 5188. Con exlibris manuscrito de Antonio Nariño.',
      url:'http://catalogoenlinea.bibliotecanacional.gov.co/client/es_ES/search/asset/69765',
      archivo:'rg_5187_v1_Página_006',
      estilo:'Portada, catálogo y detalle.',
    },
    {
      titulo:'Introduccion al conocimiento de las bellas artes , o, Diccionario manual de pintura, escultura, arquitectura, grabado, etc.',
      autor:'Don Francisco Martinez',
      hover:'Introduccion al conocimiento de las bellas artes (1799). Don Francisco Martinez',
      pie:'Madrid: Por la viuda de Escribano, 1788. BNC: F. Cuervo 1799. Francisco Martínez hará la traducción en Santafé de la obra de Muratori. Es muy cercano al círculo de Nariño y de Mutis. Es un peninsular clave para entender la ilustración neogranadina.',
      url:'http://catalogoenlinea.bibliotecanacional.gov.co/client/es_ES/search/asset/88193',
      archivo:'fcuervo_1799_Página_005',
      estilo:'Portada y catálogo',
    },
    {
      titulo:'Elementos de matemática',
      autor:'Bails Benito',
      hover:'Elementos de matemáticas (1777-1787). Benito Bails ',
      pie:'Madrid: Joachin Ibarra, Impresor de Cámara de S.M., 1779-1787. BNC. F. Caro 2110 Esta obra es la cumbre de las matemáticas españolas en el siglo XVIII',
      url:'http://catalogoenlinea.bibliotecanacional.gov.co/client/es_ES/search/asset/73318',
      archivo:'fcaro_2110_Página_005 (digitalizado de microfilm)',
      estilo:'Portada y catálogo',
    },
    {
      titulo:'Memorias instructivas y curiosas sobre agricultura, comercio, industria, economía, química, botánica, historia natural, etc. ',
      autor:'Suárez y Núñez Miguel Jerónimo',
      hover:'Memorias instructivas y curiosas... (1778-1791). Miguel Jerónimo Suárez y Núñez',
      pie:'Madrid: Pedro Marin, 1778-1791. BNC: F. Mutis 2083, F. Mutis 2084 Compendio ilustrado que circuló mucho en América española.',
      url:'',
      archivo:'fmutis_2083',
      estilo:'Portada y catálogo ',
    },
    {
      titulo:'Ensayo de la Sociedad Bascongada de los Amigos del Pais, año 1766 dedicado al Rey N. Señor. ',
      autor:'',
      hover:'Ensayo de la Sociedad Bascongada de los Amigos del PaÍs (1768). Thomás de Robles',
      pie:'Victoria: Thomás de Robles, 1768. BNC: F. Mutis 1850-F. Mutis 1856 Uno de los discursos que motivo la ereccón de Sociedades de Amigos del País en toda América.',
      url:'http://catalogoenlinea.bibliotecanacional.gov.co/client/es_ES/search/asset/58016',
      archivo:'fmutis_1850_pag_002',
      estilo:'Portada y catálogo',
    },
    {
      titulo:'Oracion apologética por la España y su merito literario : para que sirva de exornacion al discurso leido por el Abate Denina en la Academia de Ciencias de Berlin, respondiendo a la question "qué se debe a España',
      autor:'Forner Juan Pablo',
      hover:'Oración apologética por la España y su mérito literario (1786). Juan Pablo Forner',
      pie:'Madrid: En la Imprenta Real, 1786. BNC: F. Mutis 4103 Respuesta de los ilustrados españoles a unos ensayos que aparecieron en la Enciclopedia y que "hablaban mal de España" Revisar a qué fondo pertenece si al Mutis o al Cuervo ',
      url:'http://catalogoenlinea.bibliotecanacional.gov.co/client/es_ES/search/asset/87446',
      archivo:'fcuervo_1712_Página_004',
      estilo:'Portada y catálogo',
    },
    {
      titulo:'Discurso sobre el fomento de la industria popular',
      autor:'Rodríguez Campomanes Pedro',
      hover:'Discurso sobre el fomento de la industria popular (1883). Pedro Rodríguez Campomanes ',
      pie:'Madrid: Antonio de Sancha, 1774. BNC: F. Mutis 1833. Campomanes es uno de los faros de la ilustración hispánica. Muy leído en su época.',
      url:'http://catalogoenlinea.bibliotecanacional.gov.co/client/es_ES/search/asset/88025',
      archivo:'fcuervo_866_Página_004',
      estilo:'Portada y catálogo',
    },
    {
      titulo:'Teatro critico universal, o Discursos varios en todo género de materias, para desengaño de errores comunes, ',
      autor:'Feijóo y Montenegro Benito Jerónimo',
      hover:'Teatro crítico universal (1734-1776). Benito Jerónimo Feijóo y Montenegro',
      pie:'Madrid: En la Imprenta de los Herederos de Francisco del Hierro, 1734-1773. BNC: F. Mutis 4036-F. Mutis 4043 Feijóo es el ilustrado español más importante de la primera mitad del siglo xviii. Esta obra quizá es de la más reimpresas en ese siglo.',
      url:'http://catalogoenlinea.bibliotecanacional.gov.co/client/es_ES/search/asset/89162',
      archivo:'fmutis_4036',
      estilo:'Portada y catálogo',
    },
    /*{
